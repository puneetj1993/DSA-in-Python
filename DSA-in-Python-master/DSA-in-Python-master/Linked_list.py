...
# Add new element in the middle(N) somewhere b/w Head and Tail: Add new element and set previous pointer to this element and this element's pointer to next element. Complexity is O(N)
